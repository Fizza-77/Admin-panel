...
function rowToPermissions(row: AppProfileRow, email: string | null | undefined): AppPermissions {
  ...
  return {
    ...
    canManageExpenses: row.can_manage_expenses,
    canManageProfiles: row.can_manage_profiles,
...
async function ensureProfileRowForUser(
  ...
  const fallbackRow: AppProfileRow = isBootstrap
    ? {
        ...
        can_manage_profiles: FULL_ACCESS_PROFILE_FLAGS.can_manage_profiles,
        can_manage_payroll: FULL_ACCESS_PROFILE_FLAGS.can_manage_payroll,
        display_name: null,
        surname: null,
        qualification: null,
        contact_info: null,
    ...
    : {
        ...
        can_manage_profiles: DEFAULT_APP_PROFILE_FLAGS.can_manage_profiles,
        can_manage_payroll: DEFAULT_APP_PROFILE_FLAGS.can_manage_payroll,
        display_name: null,
        surname: null,
        qualification: null,
        contact_info: null,
